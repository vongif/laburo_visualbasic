VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmZPDD 
   Caption         =   "ZPDD"
   ClientHeight    =   9780.001
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   8310.001
   OleObjectBlob   =   "frmZPDD.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmZPDD"
...
Private Sub UserForm_Initialize()
    ...
    With lstResumen
        .ColumnCount = 4
        .ColumnWidths = "80 pt;100 pt;80 pt;60 pt"
    End With
...
Private Sub GuardarYLimpiar()
    Dim hoja As Worksheet: Set hoja = ThisWorkbook.Sheets("ZPDD_devo_minorista")
    Dim fila As Long
